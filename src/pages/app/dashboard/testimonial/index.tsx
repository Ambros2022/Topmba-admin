...
const SecondPage = () => {
  ...
  const handleDownloadAll = async () => {
    try {
      setLoading(true)
      const response = await axios1.get('api/admin/videotestimonials/get', {
        params: {
          columnname,
          orderby,
          page: 1,
      ...
      // Create CSV header
      const headers = ['ID', 'Type', 'Name', 'Designation', 'Video URL']
      ...
      link.setAttribute('download', 'all_testimonials.csv')
